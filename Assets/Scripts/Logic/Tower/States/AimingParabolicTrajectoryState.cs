...
public class AimingParabolicTrajectoryState : AimingBaseState
{
    ...
    {
        if (_model.TargetingSystem.CalculateParabolicAimDirectionVector(_model.GunPosition, _model.Target.CurrentPosition, _model.Target.Velocity, _model.AimDuration, _model.ProjectileSpeed, out Vector3 aimVector))
        {
