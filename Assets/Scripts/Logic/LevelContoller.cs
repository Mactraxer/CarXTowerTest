...
public class LevelContoller
{
    ...
    private List<TowerPresenter> _towers;
    private List<EnemyPresenter> _enemies;
    private ITimer _spawnEnemyRepeatingTimer;

    public LevelContoller(LevelModel levelModel, LevelView levelView, ITowerFactory towerFactory, ITimerService timerService, IEnemyFactory enemyFactory)
    {
